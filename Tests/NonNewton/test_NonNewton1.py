...
if __name__ == "__main__":
    ...
    draw(x, y, 'm', label = 'Carreau, consistency_index = 0.1, power_index = 0.9')
    [x,y] = test_NonNewton('Bingham', criticalStrainRate = 1.0)
    np.savetxt(this_path + '/Bingham.csv', np.array([x,y]).transpose())
    draw(x, y, 'r', label = 'Bingham, criticalStrainRate = 1.0')
    ...
    draw(x, y, 'k', label = 'HerschelBulkley, consistency_index = 60.0, power_index=0.667, criticalStrainRate = 1.0')
